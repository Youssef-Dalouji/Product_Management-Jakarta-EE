			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="input-group mb-3">
						<form id="seachForm" class="input-group mb-3" action="product.php" method="post">
						...
						<c:forEach items="${model.getTable() }" var="message">
							<tr>
								...
								<form method="post" action="editProduct.php">
									...
									<button type="submit" class="icon-link icon-link-hover link-success border-0 bg-white"
								...
								<td>
									<form method="post" action="deleteProduct.php">
										<input type="hidden" name="id" value="${message.getId() }" />
										<button type="submit" class="icon-link icon-link-hover link-danger border-0 bg-white"
											style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);"
